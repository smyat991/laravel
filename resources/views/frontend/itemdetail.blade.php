    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                ...
                <button class="btn-outline-danger mybtn" data-id="{{$item_detail->id}}" data-name="{{$item_detail->name}}" data-price="{{$item_detail->price}}" data-photo="{{$item_detail->photo}}" data-discount="{{$item_detail->discount}}">Add to Cart</button>
